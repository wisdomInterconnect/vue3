<template>
    <div id="weathet" :class="typeof weather.main != 'undefined' && weather.main.temp > 16 ? 'warm':'' ">
        <Header></Header>
        <h1 class="text-danger">Weather App</h1>
...
import Header from '@/components/Header.vue'
    export default {
        ...
        data(){
            return{
                api_key: 'e80100a8dcf5a53d2ba40cec9e5ad3e1',
